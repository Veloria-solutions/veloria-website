...
const steps = [
  {
    n: "01",
    title: "We assess",
    desc: "We audit your current digital presence and map out a complete strategy tailored to your business.",
  },
  {
    n: "02",
    title: "We build",
    desc: "We design and integrate all four services — website, chatbot, reservations, and booking — into one seamless system.",
  },
  {
    n: "03",
    title: "We maintain",
    desc: "Each month we update, optimise, and support everything so your business stays ahead without you lifting a finger.",
  },
];
    ...
    <div className="pt-24">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="gradient-text">Managed monthly.</span>
            </motion.h1>
            <motion.p
              variants={fadeUp}
      ...
      <section className="py-24 bg-[#0C0C0C] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
          ...
          >
            <h2 className="text-3xl md:text-[46px] font-black leading-tight tracking-tight font-satoshi">
              Ready to hand it all{" "}
              <span className="gradient-text">over to us?</span>
            </h2>
            <p className="text-[#A1A1A1] text-lg leading-relaxed">
              We&apos;ll handle every detail. You focus on running your business.
            </p>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-black font-bold text-[13.5px] tracking-wide rounded-full hover:bg-[#8DBBFF] hover:scale-[1.04] transition-all duration-300 shadow-xl shadow-white/10"
