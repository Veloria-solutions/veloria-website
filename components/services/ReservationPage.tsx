      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            >
              Let customers book while{" "}
              <span className="gradient-text">you focus on the work.</span>
            </motion.h1>
            <motion.p
              variants={fadeUp}
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
          ...
          >
            <h2 className="text-3xl md:text-[46px] font-black leading-tight tracking-tight font-satoshi">
              Ready to simplify{" "}
              <span className="gradient-text">your reservations?</span>
            </h2>
            <p className="text-[#A1A1A1] text-lg leading-relaxed">
              We&apos;ll show you exactly how it works. No commitment required.
            </p>
            <Link
              href="/contact"
